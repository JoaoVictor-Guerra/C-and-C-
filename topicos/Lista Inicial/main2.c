...
int exd()
{
    ...
    printf("%.2f fahrenheit são %.2f celsius",fahrenheit,celsius);
...
int exg(){
    ...
    printf("Após 5 dias, ainda há %.2f KG no saco de ração comprado.",(((saco_racao*1000)- quantidade_total))/1000);
...
int exi(){
     ...
     printf("O resultado da divisão é %i", divinteira);
...
int exj(){
     ...
     printf("A soma dos termos dessa P.A é %i",sn);
